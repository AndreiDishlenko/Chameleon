...
{
public:
    IAcroAXDocShim(IDispatch *subobject = 0, QAxObject *parent = 0) : QAxObject((IUnknown*)subobject, parent)
    {
        internalRelease();
    }
    ~IAcroAXDocShim() {qDebug() << "~IAcroAXDocShim";}
    /*
...
//        qDebug() << "control" << control();
    ...
    ~AcroPDF() {QProcess pPdfviewer(this); pPdfviewer.kill(); qDebug() << "~AcroPDF";}
    /*
    Property messageHandler
...
public:
    ...
    ~AdobeSPOpenDocuments() { qDebug() << "~AdobeSPOpenDocuments";}
